...
# проверка на добавление книги с названием больше 40 символов или 0 символов
@pytest.mark.parametrize('book_name', ['', 'БольшаяКнигаНастолькоЧтоНеУмещаетсяСюдаОй'])
def test_add_new_book_without_genre_more_than_40symbols_or_null(book_collector, book_name):
...
# проверка на добавление книги с названием 40 символов или 1 символом
@pytest.mark.parametrize('book_name', ['А', 'БольшаяКнигаНастолькоЧтоУмещаетсяСюдаУра'])
def test_add_new_book_with_one_or_forty_symbols(book_collector, book_name):
    book_collector.add_new_book(book_name)
